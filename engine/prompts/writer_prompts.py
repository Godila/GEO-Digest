...
SECTION_TARGETS = {
    "введение":        {"words": (600, 1200),  "tokens": 10000},
    "обзор литературы": {"words": (2000, 3500), "tokens": 24000},
    "методы":           {"words": (1500, 2500), "tokens": 18000},
    "результаты":       {"words": (1800, 3000), "tokens": 24000},
    "обсуждение":       {"words": (2000, 3500), "tokens": 24000},
    "выводы":           {"words": (400, 700),   "tokens": 7000},
    "список литературы": {"words": (200, 500),  "tokens": 4000},
    # English fallback
    "introduction":    {"words": (600, 1200),  "tokens": 10000},
    "literature":      {"words": (2000, 3500), "tokens": 24000},
    "methods":         {"words": (1500, 2500), "tokens": 18000},
    "results":         {"words": (1800, 3000), "tokens": 24000},
    "discussion":      {"words": (2000, 3500), "tokens": 24000},
    "conclusion":      {"words": (400, 700),   "tokens": 7000},
    "references":      {"words": (200, 500),   "tokens": 4000},
}
...
- Введение: 4-8 абзацев, 600-1200 слов (контекст → история → проблема → цель → задачи)
- Обзор литературы: 8-15 абзацев, 2000-3500 слов (критический анализ, сравнение подходов, выявление пробелов)
- Методы: 6-12 абзацев, 1500-2500 слов (данные → методы → обоснование → параметры → ограничения)
- Результаты: 8-15 абзацев, 1800-3000 слов (цифры → таблицы → сравнения → статистика)
- Обсуждение: 8-15 абзацев, 2000-3500 слов (интерпретация → сравнение → механизм → ограничения → перспективы)
- Выводы: 2-4 абзаца, 400-700 слов (резюме + значимость + рекомендации)"""
